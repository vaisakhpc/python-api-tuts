...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        exemption_limit = Decimal(
            "1200000"
        )  # ₹12,00,000 (approximate effective exemption)
        ...
        tax_year = IncomeTaxYear.objects.create(
            year=year, exemption_limit=exemption_limit
        )

        # New regime slabs for FY 2025-26 as per Union Budget Feb 2025
        slabs = [
            {
                "upper_income_limit": Decimal("400000"),
                "tax_rate_percent": Decimal("0"),
            },  # Up to 4L: 0%
            {
                "upper_income_limit": Decimal("800000"),
                "tax_rate_percent": Decimal("5"),
            },  # 4L - 8L: 5%
            {
                "upper_income_limit": Decimal("1200000"),
                "tax_rate_percent": Decimal("10"),
            },  # 8L - 12L: 10%
            {
                "upper_income_limit": Decimal("1600000"),
                "tax_rate_percent": Decimal("15"),
            },  # 12L - 16L: 15%
            {
                "upper_income_limit": Decimal("2000000"),
                "tax_rate_percent": Decimal("20"),
            },  # 16L - 20L: 20%
            {
                "upper_income_limit": Decimal("2400000"),
                "tax_rate_percent": Decimal("25"),
            },  # 20L - 24L: 25%
            {
                "upper_income_limit": None,
                "tax_rate_percent": Decimal("30"),
            },  # Above 24L: 30%
        ]
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Successfully created Income Tax Year {year} and slabs for FY 2025-26."
            )
        )
