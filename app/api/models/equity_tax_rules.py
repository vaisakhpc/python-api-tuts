...
class EquityTaxRates(models.Model):
    year = models.PositiveIntegerField(unique=True, help_text="Financial year (e.g., 2025)")
    ltcg_rate_percent = models.DecimalField(max_digits=5, decimal_places=2, help_text="LTCG Tax Rate (%) for equities")
    stcg_rate_percent = models.DecimalField(max_digits=5, decimal_places=2, help_text="STCG Tax Rate (%) for equities")
