...
from api.views.user_registration_view import ResendRegistrationEmailView, ForgotPasswordEmailView
...
urlpatterns = [
    ...
    path("user/forgot-password/", ForgotPasswordEmailView.as_view()),
