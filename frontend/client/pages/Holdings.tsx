...
export default function Holdings() {
  ...
  const paginatedHoldings = filteredHoldings.slice(startIndex, startIndex + pageSize);

  // Calculate portfolio summary
  const portfolioSummary = {
    totalValue: holdings.reduce((sum, holding) => sum + holding.totalCurrentValue, 0),
    totalInvested: holdings.reduce((sum, holding) => sum + holding.totalInvestedValue, 0),
    totalGainLoss: holdings.reduce((sum, holding) => sum + holding.totalGainLoss, 0)
  };
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  ...
                  <div className="text-center p-4 border rounded-lg">
                    ...
                    <div className="text-sm text-muted-foreground">
                      {portfolioSummary.totalGainLoss >= 0 ? 'Total Gains' : 'Total Loss'}
                    </div>
                  </div>
                  <div className="text-center p-4 border rounded-lg">
                    <div className={cn(
                      "text-2xl font-bold",
                      portfolioSummary.totalGainLossPercent >= 0 ? "text-green-600" : "text-red-600"
                    )}>
                            ...
                            <TableCell className="!text-right">
                              <div className={cn(
                                ...
                                <div>
                                  ...
                                  <div className="text-xs">({holding.totalGainLossPercent.toFixed(2)}%)</div>
                                </div>
                              </div>
                            </TableCell>
                          </TableRow>
            ...
            <div className="flex items-center justify-between mt-6">
              ...
              <div className="flex items-center space-x-2">
                <p className="text-sm text-muted-foreground">
                  Page {currentPage} of {totalPages} ({filteredHoldings.length} total funds)
                </p>
